...
const AVAILABLE_ARTICLES: ConstitutionArticle[] = [
  ...
  },
  {
    ...
    importance: 3,
    placement: { x: 0, y: 0 },
    connections: ['part1-art2', 'part1-art4'],
    correctSection: 'union_territory'
  },
  {
    id: 'part1-art4',
    title: 'Article 4: Laws Made Under Articles 2 and 3',
    content: 'Parliament may by law provide for admission or establishment of new States without amending this Constitution.',
    category: 'union_territory',
    importance: 3,
    placement: { x: 0, y: 0 },
    connections: ['part1-art3'],
    correctSection: 'union_territory'
  },
