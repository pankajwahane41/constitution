...
const MobileDashboard: React.FC<MobileDashboardProps> = ({
  ...
  return (
    <motion.div 
      className="mobile-container safe-area-inset-top safe-area-inset-bottom pb-28"
    ...
    >
      ...
      >
        <motion.div 
          className="w-24 h-24 mx-auto mb-4 rounded-full flex items-center justify-center shadow-premium-lg relative overflow-hidden"
          style={{
      ...
      <motion.div 
        className="mobile-card-elevated mb-6"
        variants={itemVariants}
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-bold text-navy-800 text-lg">Level Progress</h3>
              <p className="text-sm text-gray-600">
                {userProfile.experiencePoints} / {LEVEL_THRESHOLDS[userProfile.profileLevel + 1] || userProfile.experiencePoints} XP
              </p>
            </div>
          </div>
          <motion.div
        ...
        <p className="text-xs text-gray-500 mt-3 font-medium">
          {getXPToNextLevel(userProfile.experiencePoints)} XP to next level
        </p>
      </motion.div>

      {/* Premium Quick Stats Grid */}
      <motion.div 
        className="mobile-stats-grid mb-6"
        variants={itemVariants}
      >
        <StatTooltip tooltip="Total Constitutional Coins earned through quizzes, achievements, and daily challenges">
          <motion.div 
            ...
            whileTap={{ scale: 0.95 }}
          >
            <div className="w-12 h-12 mx-auto mb-2 rounded-xl bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center shadow-lg">
        ...
        <motion.div 
          ...
          whileTap={{ scale: 0.95 }}
        >
          <div className={`w-12 h-12 mx-auto mb-2 rounded-xl bg-gradient-to-br ${streakColors.gradient} flex items-center justify-center shadow-lg`}>
            <Flame className="w-6 h-6 text-white" />
          </div>
          <div className={`text-2xl font-bold ${streakColors.text}`}>
      ...
      <motion.div 
        ...
        variants={itemVariants}
      >
        <h2 className="mobile-text-title flex items-center space-x-2 mb-4">
      ...
      <motion.div 
        className="mobile-card-gradient"
        variants={itemVariants}
        whileHover={{ scale: 1.02 }}
        whileTap={{ scale: 0.98 }}
      >
