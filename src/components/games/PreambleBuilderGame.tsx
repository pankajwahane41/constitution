...
const PreambleBuilderGame: React.FC<PreambleBuilderGameProps> = ({ 
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 bg-gradient-to-br from-orange-50 via-white to-green-50 min-h-screen">
      {/* Header */}
      <div className="flex items-center justify-between mb-8">
        {onBack && (
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={onBack}
            className="flex items-center gap-2 px-4 py-2 rounded-lg text-gray-600 hover:text-gray-900 hover:bg-white hover:shadow-md transition-all duration-200"
          >
            <ArrowLeft size={20} />
            Back to Games
          </motion.button>
        ...
        <div className="flex-1 text-center">
          <motion.h1 
            ...
            className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-orange-600 via-blue-600 to-green-600 bg-clip-text text-transparent mb-2"
          >
      ...
      {gameStarted && (
        <motion.div 
          ...
          className="bg-white rounded-xl shadow-lg p-6 mb-6 border-t-4 border-gradient-to-r from-orange-400 via-white to-green-400"
        >
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-center mb-4">
            ...
            <div className="bg-gradient-to-br from-red-100 to-red-200 rounded-lg p-3">
              <div className="text-2xl font-bold text-red-600">{hintsUsed}</div>
              <div className="text-sm text-red-800">Hints</div>
            </div>
          </div>
      ...
      {!gameStarted ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            <div className="bg-white rounded-xl shadow-lg p-6 border-t-4 border-gradient-to-r from-orange-400 via-white to-green-400">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex gap-2">
                  ...
                  <motion.button
                    ...
                    className="p-2 rounded-lg bg-yellow-100 hover:bg-yellow-200 text-yellow-700 transition-colors disabled:opacity-50"
                  >
                    <Lightbulb size={16} />
                  </motion.button>
                </div>
              ...
              {isPaused && (
                <div className="bg-blue-100 border border-blue-300 rounded-lg p-4 mb-4 text-center">
                  <Pause size={20} className="inline mr-2 text-blue-600" />
                  <span className="text-blue-800 font-medium">Game Paused</span>
                </div>
              )}
                ...
                <AnimatePresence>
                  {availableWords.map((word) => (
                    <motion.div
                      ...
                      className={`p-3 rounded-lg shadow-md cursor-pointer text-center font-semibold transition-all duration-200 hover:shadow-lg min-h-[56px] flex items-center justify-center ${
                        selectedWord?.id === word.id
                          ? 'bg-gradient-to-r from-yellow-200 to-yellow-300 text-yellow-900 ring-4 ring-yellow-400 ring-offset-2 scale-105'
          ...
          >
            <div className="bg-white rounded-xl shadow-lg p-6 border-t-4 border-gradient-to-r from-safford-400 via-white to-green-400">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex gap-2">
                  <motion.button
                    ...
                    disabled={currentPosition >= PREAMBLE_WORDS.length}
                    className="px-3 py-1 text-sm rounded-lg bg-purple-100 hover:bg-purple-200 text-purple-700 transition-colors disabled:opacity-50"
                  >
                    💡 Show Next Word
                  </motion.button>
                  <motion.button
              ...
              <div className="mb-6 p-4 bg-gradient-to-r from-orange-100 via-white to-green-100 rounded-lg border-l-4 border-orange-500">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                {PREAMBLE_WORDS.map((expectedWord, index) => {
                  ...
                  return (
                    <motion.div
                      key={index}
                      className={`min-h-[60px] p-3 rounded-lg border-2 flex items-center justify-center text-center transition-all duration-300 cursor-pointer ${
                        isNext 
                          ? selectedWord
