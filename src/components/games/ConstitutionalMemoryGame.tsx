    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
          ...
          <div className="w-full px-2 sm:px-4 lg:px-6">
            <div className="flex items-center justify-between h-14 sm:h-16">
              <div className="flex items-center space-x-2 sm:space-x-4">
                <button
                  onClick={onBack}
                  className="mobile-game-button p-2 rounded-lg text-gray-600 hover:text-gray-900 hover:bg-gray-100 transition-colors"
                >
                  <ArrowLeft className="w-4 h-4 sm:w-5 sm:h-5" />
                </button>
                <h1 className="text-lg sm:text-2xl font-bold text-gray-900 line-clamp-1">Constitutional Memory Game</h1>
              </div>
              <div className="flex items-center space-x-1 sm:space-x-2 text-xs sm:text-sm text-gray-600">
                <Trophy className="w-3 h-3 sm:w-4 sm:h-4" />
                <span className="hidden sm:inline">High Score: {highScore}%</span>
                <span className="sm:hidden">{highScore}%</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full px-3 sm:px-4 lg:px-6 py-4 sm:py-6">
          {/* Game Introduction - Mobile Optimized */}
          <div className="text-center mb-8 sm:mb-12">
            <Brain className="w-16 h-16 sm:w-20 sm:h-20 text-blue-500 mx-auto mb-4 sm:mb-6 animate-pulse" />
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">Test Your Constitutional Knowledge!</h2>
            <p className="text-sm sm:text-lg text-gray-600 w-full mb-6 sm:mb-8 leading-relaxed">
          ...
          <div className="mb-8 sm:mb-12">
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6 text-center">Choose Your Challenge</h3>
            <div className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-3">
              {Object.entries(DIFFICULTY_LEVELS).map(([key, settings]) => (
                <button
                  key={key}
                  onClick={() => setDifficulty(key as 'easy' | 'medium' | 'hard')}
                  className={`mobile-game-card p-4 sm:p-6 rounded-xl border-2 transition-all hover:shadow-md hover:bg-orange-50 ${
                    difficulty === key
                ...
                >
                  <div className="text-center">
                    <Target className={`w-8 h-8 sm:w-12 sm:h-12 mx-auto mb-3 sm:mb-4 ${
                      difficulty === key ? 'text-blue-500' : 'text-gray-400'
                    }`} />
                    <h4 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">{settings.title}</h4>
                    <p className="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4">
                      {settings.pairs} pairs • {settings.gridCols} columns
                    </p>
                    <div className="flex items-center justify-center space-x-1 sm:space-x-2 text-yellow-600">
          ...
          {/* Game Statistics - Mobile Optimized */}
          <div className="mobile-game-card bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-6 sm:mb-8">
            <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-3 sm:mb-4">Your Memory Stats</h3>
            <div className="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-4">
              <div className="text-center p-3 sm:p-4 bg-blue-50 rounded-lg">
                <Trophy className="w-6 h-6 sm:w-8 sm:h-8 text-blue-500 mx-auto mb-2" />
                <div className="text-lg sm:text-2xl font-bold text-gray-900">{highScore}</div>
              ...
              <div className="text-center p-3 sm:p-4 bg-green-50 rounded-lg">
                ...
                <div className="text-lg sm:text-2xl font-bold text-gray-900">25-75</div>
                <div className="text-xs sm:text-sm text-gray-600">Coins Reward</div>
              </div>
              <div className="text-center p-3 sm:p-4 bg-purple-50 rounded-lg">
                <Star className="w-6 h-6 sm:w-8 sm:h-8 text-purple-500 mx-auto mb-2" />
                <div className="text-lg sm:text-2xl font-bold text-gray-900">20-60</div>
          ...
          <div className="text-center">
            <button
              onClick={startGame}
              className="mobile-game-button inline-flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-bold text-lg rounded-xl hover:from-blue-600 hover:to-purple-700 hover:shadow-xl active:shadow-md transition-all shadow-lg min-h-[56px]"
              style={{ touchAction: 'manipulation' }}
            >
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between h-auto sm:h-16 py-3 sm:py-0 space-y-3 sm:space-y-0">
            <div className="flex items-center space-x-2 sm:space-x-4">
              <button
                onClick={onBack}
                className="mobile-game-button p-2 rounded-lg text-gray-600 hover:text-gray-900 hover:bg-gray-100 transition-colors min-h-[44px] min-w-[44px]"
                style={{ touchAction: 'manipulation' }}
              >
                <ArrowLeft className="w-4 h-4 sm:w-5 sm:h-5" />
              </button>
              <h1 className="text-base sm:text-xl font-bold text-gray-900 line-clamp-1">Constitutional Memory Game</h1>
            </div>
      ...
      <div className="w-full px-3 sm:px-4 lg:px-6 py-4">
        {/* Game Board - Mobile Optimized Memory Grid */}
        <div className="mb-6 sm:mb-8">
          <div 
            className={`mobile-memory-grid grid gap-2 sm:gap-3 mx-auto`}
            style={{ 
              gridTemplateColumns: `repeat(${difficulty === 'easy' ? '3' : difficulty === 'medium' ? '4' : '5'}, 1fr)`,
              maxWidth: difficulty === 'easy' ? '300px' : difficulty === 'medium' ? '400px' : '500px'
            }}
          >
            {cards.map((card) => (
              <div
                ...
                className={`mobile-memory-card aspect-square cursor-pointer transform transition-all duration-300 ${
                  card.isMatched ? 'opacity-75' : 'hover:shadow-md hover:bg-orange-50 active:shadow-sm'
                } ${!card.isFlipped && !card.isMatched ? 'hover:shadow-lg' : ''}`}
                style={{ 
                  touchAction: 'manipulation',
                  minHeight: difficulty === 'easy' ? '80px' : difficulty === 'medium' ? '70px' : '60px'
                }}
              >
