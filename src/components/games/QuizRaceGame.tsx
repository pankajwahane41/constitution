...
export const QuizRaceGame: React.FC<QuizRaceGameProps> = ({
  ...
  if (gameState === 'intro') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-400 via-orange-500 to-red-500 p-4 flex items-center justify-center relative overflow-hidden">
        {/* Racing background effect */}
        ...
        <Card className="max-w-2xl w-full p-8 text-center relative z-10 bg-white/95 backdrop-blur-sm shadow-2xl">
          <div className="mb-8">
            <div className="flex justify-center mb-6">
              <div className="relative">
                <Car className="w-24 h-24 text-orange-500 animate-bounce" />
                {/* Racing trail effect */}
                <div className="absolute inset-0 -z-10 animate-pulse">
                  <div className="w-32 h-4 bg-orange-300 opacity-30 blur-sm rounded-full" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-yellow-400 to-orange-400 text-white p-3 rounded-lg mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-8">
            <div className="bg-orange-100 p-4 rounded-lg border-2 border-orange-200 hover:border-orange-300 transition-all duration-300 hover:shadow-lg">
              <Clock className="w-8 h-8 text-orange-500 mx-auto mb-2" />
              <h3 className="font-bold text-lg">10 Seconds</h3>
              <p className="text-sm">Per Question</p>
            </div>
            <div className="bg-green-100 p-4 rounded-lg border-2 border-green-200 hover:border-green-300 transition-all duration-300 hover:shadow-lg">
              <Target className="w-8 h-8 text-green-500 mx-auto mb-2" />
              <h3 className="font-bold text-lg">3 Laps</h3>
              <p className="text-sm">Constitutional Track</p>
            </div>
            <div className="bg-blue-100 p-4 rounded-lg border-2 border-blue-200 hover:border-blue-300 transition-all duration-300 hover:shadow-lg">
              <Coins className="w-8 h-8 text-blue-500 mx-auto mb-2" />
              <h3 className="font-bold text-lg">10-75 Coins</h3>
              <p className="text-sm">Speed & Streak Bonuses</p>
            </div>
            <div className="bg-purple-100 p-4 rounded-lg border-2 border-purple-200 hover:border-purple-300 transition-all duration-300 hover:shadow-lg">
              <Trophy className="w-8 h-8 text-purple-500 mx-auto mb-2" />
              <h3 className="font-bold text-lg">Leaderboard</h3>
              <p className="text-sm">Best Race Times</p>
            </div>
          </div>

          {/* Racing Tips */}
          <div className="bg-gradient-to-r from-gray-100 to-gray-200 p-4 rounded-lg mb-6">
            <h4 className="font-bold text-gray-700 mb-2">🏎️ Racing Tips:</h4>
          ...
          <div className="space-y-4">
            <Button 
              onClick={startGame}
              className="mobile-game-button w-full bg-orange-500 hover:bg-orange-600 text-white text-lg py-4 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 active:scale-95 min-h-[56px]"
  ...
  if (gameState === 'racing' && questionState) {
    ...
    return (
      <div className={`min-h-screen p-4 transition-all duration-500 ${getBackgroundClass()}`}>
        ...
        <div className="max-w-4xl mx-auto">
          {/* Enhanced Header with race info */}
          <div className={`bg-white rounded-lg p-4 mb-4 shadow-lg transition-all duration-300 ${
            ...
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="flex items-center space-x-4">
                <div className="text-right">
                  ...
                  <div className="text-lg font-bold">{currentQuestionIndex + 1}</div>
                </div>
                <Button 
                  variant="outline" 
                  size="sm"
                  onClick={onBack}
                  className="hover:bg-red-50 hover:border-red-300 min-h-[44px] min-w-[60px]"
                  style={{ touchAction: 'manipulation' }}
                >
                  Exit
                </Button>
          ...
          <Card className="p-6 mb-4">
            ...
            {/* Question */}
            <div className="mb-6">
              <h2 className="text-xl font-bold mb-4">{questionState.question.question}</h2>
              ...
              <div className="grid grid-cols-1 gap-3">
                {questionState.question.options.map((option, index) => (
                  <Button
                    ...
                    className={`mobile-game-button p-4 h-auto text-left justify-start whitespace-normal min-h-[60px] ${
  ...
  if (gameState === 'finished') {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-600 via-pink-600 to-red-500 p-4 flex items-center justify-center relative overflow-hidden">
        ...
        <Card className="max-w-3xl w-full p-8 text-center relative z-10 bg-white/95 backdrop-blur-sm shadow-2xl">
          <div className="mb-6">
            <div className="flex justify-center mb-4">
              <div className="relative">
                <Flag className="w-24 h-24 text-purple-600 animate-bounce" />
                <div className="absolute inset-0 -z-10 animate-pulse">
                  <div className="w-32 h-4 bg-purple-300 opacity-30 blur-sm rounded-full" />
                </div>
              </div>
            </div>
          ...
          {achievements.length > 0 && (
            <div className="mb-8">
              <h3 className="text-lg font-bold mb-4 text-gray-700">🏅 Achievements Unlocked!</h3>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {achievements.map((achievement, index) => (
                  <div key={index} className="bg-gradient-to-br from-yellow-100 to-orange-100 p-3 rounded-lg border-2 border-yellow-300">
          ...
          <div className="space-y-4">
            <Button 
              ...
              className="mobile-game-button w-full bg-purple-500 hover:bg-purple-600 active:bg-purple-700 text-white text-lg py-4 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 active:scale-95 min-h-[56px]"
              style={{ touchAction: 'manipulation' }}
            >
              Race Again!
            </Button>
